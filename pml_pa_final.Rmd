...
I select 10% of the data to choose accuracy method. the code is on file **pa_pml.Rmd**. The results are: 
...
The data was splitted 75% for training, 25% for testing, the training was spent 14 hours in my computer. I used The following code:
...
Confusion matrix show that the method is very accuracy, only 54 samples from 14717 was wrong.

The accuracy is `r round(mF3$result$Accuracy[2],3)` 
...
I test the 20 testing samples and the answer is the same with both models.
